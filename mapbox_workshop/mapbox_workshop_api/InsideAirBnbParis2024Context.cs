...
public partial class InsideAirBnbParis2024Context : DbContext
{
    public InsideAirBnbParis2024Context()
    {
    }

    public InsideAirBnbParis2024Context(DbContextOptions<InsideAirBnbParis2024Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=InsideAirBNB-Paris-2024;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetailedCalendarParijsConverted>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Detailed_Calendar_Parijs_Converted");
        ...
        modelBuilder.Entity<DetailedListingsParij>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Detailed_Listings_Parijs");
        ...
        modelBuilder.Entity<DetailedReviewsParij>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Detailed_Reviews_Parijs");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_listingsv2");
